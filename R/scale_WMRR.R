...
#' wavelet multiresolution analysis. It can be used to fit
#' generalized linear models taking the two-dimensional grid structure of
...
#' "binomial"(binary) or "poisson". The model provides scale-specific
